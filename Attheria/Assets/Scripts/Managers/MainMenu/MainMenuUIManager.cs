...
namespace MainMenu
{
    public class MainMenuUIManager : MonoBehaviour
    {
        ...
        [Header("Server messages")] public GameObject ResponseMessageInstance;
        ...
        [Space(10)] private bool settingsMenuOpened = false;
        private bool firstSingleplayerOpen = true;
        [Header("Loading screen")] public GameObject LoadingScreenCanvas;
        ...
        public TMP_InputField DevInp;
        public bool OverrideSteamId; 
        ...
        public void SetOverride(bool s)
        {
            OverrideSteamId = s;
        }
